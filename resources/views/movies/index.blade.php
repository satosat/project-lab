...
@section('content')
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="/images/banner_greatest.jpeg" alt="Matrix" class="d-block" style="width:100%; height:500px">
                <div class="carousel-caption text-white mb-lg-5 text-right">
                    <div class="row-sm-2 mb-3 d-flex">Action | 2021</div>
                    <div class="row-sm-2 mb-3 d-flex"><h3>The Greatest Showman</h3></div>
                    <div class="row-sm-2 mb-lg-5 d-flex"><p>Description</p></div>
            ...
            <div class="carousel-item active">
                <img src="/images/banner_spiderman.webp" alt="Matrix" class="d-block" style="width:100%; height:500px">
                <div class="carousel-caption text-white mb-lg-5 text-right">
                    <div class="row-sm-2 mb-3 d-flex">Action | 2021</div>
                    <div class="row-sm-2 mb-3 d-flex"><h3>Spiderman : No Way Home</h3></div>
    ...
    <div class="content">
            ...
            @foreach ($movies as $movie)
                <div class="card bg-dark text-white border m-3" style="width: 230px">
                    <a href={{ "movies/".$movie->id }} style="text-decoration:none">
                        <img src={{ "images/".$movie->thumbnail_source }} alt="" class="card-img-top mt-2" style="width:100%">
                    </a>
                    <div class="card-body">
        ...
        <div class="mt-3 d-flex justify-content-between">
            ...
            <div class="search-movie mx-5 align-self-center">
                <div class="form-outline btn-secondary">
                    <input type="search" id="form1" class="form-control bg-dark text-white" placeholder="Search movie..." />
                </div>
            </div>
        </div>
        ...
        <div class="d-flex text-white row mt-5 mx-5 align-middle">
            ...
            <div class="col-3"><button type="button" class="btn btn-secondary" style="width:100px">Lastest</button></div>
